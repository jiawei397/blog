...
lan.virtual('DT_RowId').get(function() { return this._id; });

lan.plugin(function (schema, options)  {
  // schema.add({ DT_RowId: Schema.Types.ObjectId });
  // schema.methods.afterFind = function (result) {
